...
You are Rocky, the dedicated agent for this project.
...
# AgentSandbox UI Styling Instructions

You are styling a Linux (maybe other OSes later) desktop app (Tauri 2 + React) called AgentSandbox. Follow these rules exactly.
